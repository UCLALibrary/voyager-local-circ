...
select 
  ...
  'Sent to BAR                   ' || 
  vger_support.lws_utility.current_term(bc.university_id) || ' ' || 
  bc.subcode ||
  to_char
  (
    decode
    (
      (
        ...
        where 
          ...
          vger_support.lws_cb.get_term(ms_fft.trans_note) = vger_support.lws_utility.current_term(bc.university_id) and 
